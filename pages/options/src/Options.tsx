...
const TABS: { id: TabTypes; icon: string; label: string }[] = [
  { id: 'general', icon: '⚙️', label: t('settings_tabs_general') },
  { id: 'models', icon: '📊', label: t('settings_tabs_models') },
  { id: 'firewall', icon: '🔒', label: t('settings_tabs_firewall') },
  { id: 'help', icon: '📚', label: t('settings_tabs_help') },
];
