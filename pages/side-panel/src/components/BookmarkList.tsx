            ...
            {editingId === bookmark.id ? (
              <div className="flex items-center">
                ...
                <button
                  ...
                  aria-label={t('chat_bookmarks_accessibilitySaveEdit')}
                  type="button">
                  <FaCheck size={14} />
                </button>
                <button
                  ...
                  aria-label={t('chat_bookmarks_accessibilityCancelEdit')}
                  type="button">
                  <FaTimes size={14} />
                </button>
              </div>
            ...
            {editingId !== bookmark.id && (
              <>
                ...
                <button
                  ...
                  aria-label={t('chat_bookmarks_accessibilityEdit')}
                  type="button">
                  <FaPen size={14} />
                </button>
                ...
                <button
                  ...
                  aria-label={t('chat_bookmarks_accessibilityDelete')}
                  type="button">
                  <FaTrash size={14} />
                </button>
              </>
